...
ros::spinOnce();
  ...
  if (c == '0'){
	SetPose(2.90830366989726, 0.27270372223605144,  0.0);
	SendGoal(-0.9216912234150161, 3.9235042522291472,  0.0);
	}
  else if (c == '1'){
	SendGoal(-7.718, 8.219, -1.745);
	SetPose(-2.614, -2.674,  1.534);}
  else if (c == '2'){
        SendGoal(-7.728, 7.345, -1.726);
        SetPose(-2.614, -2.674,  1.534);}
  else if (c == '3'){
        SendGoal(-6.796, 6.811,  -0.439);
        SetPose(-2.614, -2.674,  1.534);}
